...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "hackathon-insecure-secret-key")
...
WSGI_APPLICATION = "sheild.wsgi.application"
...
TRACEABILITY_FALLBACK_TO_MOCK = (
    os.getenv("TRACEABILITY_FALLBACK_TO_MOCK", "true").lower() == "true"
)
